...
| Windows桌面 | Electron 打包 x64/arm64 exe，配置自定义图标 | Pass | `release/民航客票销售订座系统-1.0.3-x64.exe`、`release/民航客票销售订座系统-1.0.3-arm64.exe` |
| 测试 | 核心领域规则、API、机场/航线数据测试 | Pass | `npm test` 26 tests |
