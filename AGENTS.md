...
- Windows x64：`civil-aviation-ticketing/release/民航客票销售订座系统-1.0.3-x64.exe`
- Windows arm64：`civil-aviation-ticketing/release/民航客票销售订座系统-1.0.3-arm64.exe`
...
- Windows exe 未签名；已配置自定义图标，正式外发前可补代码签名。
